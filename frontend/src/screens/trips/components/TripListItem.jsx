...
const TripListItem = (props) => {
  ...
  return (
    <div className="grid-itinerary">
      <div>
        <Button onClick={()=>{history.push(`/itinerary/${props.trip.id}/${props.trip.country}/${props.trip.city}`)}}><span className='trip-name'><strong>{props.trip.trip_name}</strong></span></Button>
